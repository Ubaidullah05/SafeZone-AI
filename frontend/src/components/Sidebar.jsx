import { Shield, Map, Radio, Brain, Wifi, Zap, Users, Home, ChevronLeft, ChevronRight } from 'lucide-react'
...
const NAV = [
  ...
  { id: 'mesh', icon: Wifi, label: 'Network Health', color: '#22D3EE' },
...
export default function Sidebar({ activeTab, onTabChange, sosCount }) {
        ...
        <div className="hidden px-3 lg:block">
          <div className="rounded-xl border border-theme bg-panel p-3.5">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <span className="font-mono text-2xs uppercase tracking-wide text-muted">System Online</span>
                <span className="block font-mono text-2xs text-muted">17 mesh nodes active</span>
              </div>
            </div>
          </div>
        </div>
